...
if (!class_exists('TerraClassifiedsCategories')) {
	...
	class TerraClassifiedsCategories extends WP_Widget
	{
		...
		function widget($args, $instance)
		{
			...
			$orderby = !empty($instance['orderby']) ? (int) $instance['orderby'] : '0';
			$order = !empty($instance['order']) ? (int) $instance['order'] : '0';
...
?>
		...
		function form($instance)
		{
			...
			$columns      = !empty($instance['columns']) ? (int) $instance['columns'] : '1';
			$depth      = !empty($instance['depth']) ? (int) $instance['depth'] : '0';
			$order_by      = !empty($instance['orderby']) ? (int) $instance['orderby'] : '0';
			$order      = !empty($instance['order']) ? (int) $instance['order'] : '0';
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e('Order by:', 'terraclassifieds'); ?></label>
				<select name="<?php echo $this->get_field_name('orderby'); ?>" id="<?php echo $this->get_field_id('orderby'); ?>">
					<option value="0" <?php selected($order_by, '0'); ?>><?php _e('Name', 'terraclassifieds'); ?></option>
					<option value="1" <?php selected($order_by, '1'); ?>><?php _e('ID', 'terraclassifieds'); ?></option>
				</select>
			</p>
			...
			<p>
				...
				<select name="<?php echo $this->get_field_name('order'); ?>" id="<?php echo $this->get_field_id('order'); ?>">
					<option value="0" <?php selected($order, '0'); ?>><?php _e('Ascending', 'terraclassifieds'); ?></option>
					<option value="1" <?php selected($order, '1'); ?>><?php _e('Descending', 'terraclassifieds'); ?></option>
				</select>
			</p>
